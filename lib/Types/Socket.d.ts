...
export type SocketConfig = {
    ...
    qrTimeout?: number;
    /** test-only: trust anchor for the inbound Noise cert chain. Defaults to WA_CERT_DETAILS.
     * Used by the in-process fake-server cross-check harness; leave unset in production. */
    certTrustAnchor?: {
