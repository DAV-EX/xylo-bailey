...
export const makeNoiseHandler = ({ keyPair: { private: privateKey, public: publicKey }, NOISE_HEADER, logger, routingInfo, certTrustAnchor = { publicKey: WA_CERT_DETAILS.PUBLIC_KEY, serial: WA_CERT_DETAILS.SERIAL } }) => {
    ...
    return {
        ...
        processHandshake: ({ serverHello }, noiseKey) => {
            ...
            const verifyIntermediate = Curve.verify(certTrustAnchor.publicKey, certIntermediate.details, certIntermediate.signature);
            if (!verify) {
            ...
            if (issuerSerial !== certTrustAnchor.serial) {
